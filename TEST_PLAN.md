...
compile-error fix, and two related iPad-only issues found during that retest (font-size
hang while editing code, and the line-number gutter not appearing until scrolled).
